...
img = cv2.imread('./picture/newTest3/(41).jpg')
...
faces = face_cascade.detectMultiScale(gray,1.7,5)  # 追蹤人臉 ( 目的在於標記出外框 )
print(faces)
# plt.imshow(gray) 
...
import os 
imagelist=os.listdir('./picture/newTest2/')
dataNumber=0
correctnumber=0
